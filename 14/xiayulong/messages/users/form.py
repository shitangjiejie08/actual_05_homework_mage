...
class modifyuserpasswdinfoForm(forms.Form):
    name = forms.CharField(label="用户名",error_messages={'required':"用户名不能为空"},widget=forms.HiddenInput,required=True)
    old_passwd = forms.CharField(label="旧密码",required=False,widget=forms.PasswordInput)
    new_passwd = forms.CharField(label="新密码",required=False,widget=forms.PasswordInput)
    confirm = forms.CharField(label="确认",required=False,widget=forms.PasswordInput)
...
class createuserinfoForm(forms.Form):
    name = forms.CharField(label="用户名",error_messages={'required':"用户名不能为空"})
    tel = forms.CharField(label="电话",error_messages={'required':"电话不能为空"})
    age = forms.CharField(label="年龄",error_messages={'required':"年龄不能为空"})
    passwd = forms.CharField(label="密码",widget=forms.PasswordInput,required=False)
